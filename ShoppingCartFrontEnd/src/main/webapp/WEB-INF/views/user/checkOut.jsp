	...
	<div class="container">
		...
		<div class="container">
			<div class="col-xs-offset-5 col-xs-2" style="padding-left: 0px; padding-right: 0px;">
				<img src="<c:url value="/resources/images/checkMark.gif" />" class="img-responsive">
			</div>
		</div>
		...
		<img src="<c:url value="/resources/images/sridhar.gif" />" alt="Thank You GIF" class="img-responsive center-block" />
