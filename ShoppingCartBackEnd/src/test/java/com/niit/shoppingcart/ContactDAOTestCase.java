...
public class ContactDAOTestCase {
	...
	public void createContactTestCase() {
		contact.setName("M Satyanarayana");
		contact.setEmail("satynaryana@gmail.com");
		contact.setContact("7458965321");
		contact.setMessage("Original : You designed a  online application");
