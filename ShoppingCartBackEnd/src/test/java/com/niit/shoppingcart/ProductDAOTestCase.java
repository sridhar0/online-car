...
public class ProductDAOTestCase {
	...
	public void createProductTestCase()
	{
		...
		product.setId("swift");
		product.setCategory_id("1004");
		product.setDescription("Good car in the family of hatchbatch");
		product.setName("Maruti");
		product.setPrice(480000);
		product.setQuantity(5);
		product.setSupplier_id("sridhar");
